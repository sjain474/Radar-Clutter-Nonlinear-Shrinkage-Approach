function [eigenvals, sigma, totaltime] = optimal_shrinkage(eigenvals,gamma,loss,sigma)
...
[eigenvals, time] = optshrink_impl(eigenvals,gamma,loss,sigma);
totaltime=noiseCalc+time;
end


function [eigenvals, time] = optshrink_impl(eigenvals,gamma,loss,sigma)
    tic
    sigma2 = sigma^2;
